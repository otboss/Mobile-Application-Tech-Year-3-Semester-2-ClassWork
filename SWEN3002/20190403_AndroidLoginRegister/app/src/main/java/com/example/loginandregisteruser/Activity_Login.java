...
public class Activity_Login extends Activity
{
    ...
    private PutResponse putRes = new PutResponse();
    private PostResponse postRes = new PostResponse();

    /**
     * Volley Put Request Function
     */
    private PutResponse sendPutRequest(String url){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.PUT, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                putRes = gson.fromJson(response, PutResponse.class);
            }
    ...
    /**
     * Volley Post Request Function
     */
    private PostResponse sendPostRequest(String url){
        RequestQueue queue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                // Display the first 500 characters of the response string.
                Log.i("myApp","Response is: "+ response.substring(0,500));
                postRes = gson.fromJson(response, PostResponse.class);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
